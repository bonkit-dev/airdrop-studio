...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "campaign-panel fixed left-[50%] top-[50%] z-50 grid w-[min(92vw,38rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[1.75rem] border p-6 shadow-2xl",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("campaign-muted text-sm leading-6", className)}
    {...props}
  />
));

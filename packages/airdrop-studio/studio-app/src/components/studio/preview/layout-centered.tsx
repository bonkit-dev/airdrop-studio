...
import { CenteredLayout } from "../../../../../src/runtime/layouts/centered"
...
export function LayoutCentered({ colors }: LayoutProps) {
  ...
  const layoutConfig: LayoutConfig = {
    ...
    ctaArrangement: config.ctaArrangement,
    countdownEmphasis: config.countdownEmphasis,
    statsSize: config.statsSize,
    centeredContentWidth: config.centeredContentWidth,
    centeredDensity: config.centeredDensity,
    centeredAnnouncementStyle: config.centeredAnnouncementStyle,

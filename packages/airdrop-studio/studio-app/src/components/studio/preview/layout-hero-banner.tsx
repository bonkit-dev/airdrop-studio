...
import { HeroBannerLayout } from "../../../../../src/runtime/layouts/hero-banner"
...
export function LayoutHeroBanner({ colors }: LayoutProps) {
  ...
  const layoutConfig: LayoutConfig = {
    ...
    heroBannerStatsPlacement: config.heroBannerStatsPlacement,
  ...
  const heroFallback = !config.heroImageUrl ? (
    <HeroImageRequiredState
      ...
      message="Hero Banner needs a hero image"
      hint="Choose a wide 16:9 image that fits your campaign theme."
    />
  ) : undefined

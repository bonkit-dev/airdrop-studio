...
import { StepCardLayout } from "../../../../../src/runtime/layouts/step-card"
...
export function LayoutStepCard({ colors }: LayoutProps) {
  ...
  return <StepCardLayout config={layoutConfig} colors={layoutColors} slots={studioSlots} />
}
